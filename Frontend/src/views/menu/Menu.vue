...
import { useMenuStore, useMenuViewStore } from "@/stores";
        ...
        <v-card rounded="xl" border flat>
          <v-card-text class="d-flex align-center ga-3 pa-4">
            <v-avatar color="green-lighten-5" rounded="lg" size="40">
              <v-icon color="var(--app-primary)" size="20"
    ...
    <v-row v-else-if="filteredItems.length" dense>
      ...
      <v-col cols="12" sm="6" md="4" lg="3">
        ...
        >
          ...
          <span class="text-body-2 font-weight-bold" style="color: var(--app-primary)"
            >Add New Item</span
          >
        </v-card>
      </v-col>
