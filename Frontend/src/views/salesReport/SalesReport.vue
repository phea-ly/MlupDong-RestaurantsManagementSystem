...
const summaryStats = [
  { label: 'Total Revenue', value: '$12,840.00', trend: '+12.5%', sub: 'vs yesterday', up: true,  icon: 'mdi-cash-multiple',          color: 'success' },
  { label: 'Total Orders',  value: '342',        trend: '+5.2%',  sub: 'vs yesterday', up: true,  icon: 'mdi-receipt-text-outline',   color: 'blue'    },
  { label: 'Avg. Order',    value: '$37.54',     trend: '+1.8%',  sub: 'vs yesterday', up: true,  icon: 'mdi-clipboard-list-outline', color: 'orange'  },
  { label: 'Net Profit',    value: '$8,210.00',  trend: '+10.4%', sub: 'vs yesterday', up: true,  icon: 'mdi-trending-up',            color: 'purple'  },
]
...
<template>
  <div>
    ...
    <div class="d-flex justify-space-between align-center flex-wrap ga-3 mb-5">
      <v-tabs v-model="activeTab" color="#0f9e5f" bg-color="transparent">
      ...
      <v-btn color="#0f9e5f" rounded="lg" prepend-icon="mdi-download-outline" variant="flat">
        Export Report
      </v-btn>
    </div>
