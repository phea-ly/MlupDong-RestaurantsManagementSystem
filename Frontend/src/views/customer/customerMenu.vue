  ...
  <div class="mobile-layout">
    ...
    <template v-else>
      ...
      <div class="sticky-header">
        <div class="d-flex align-center justify-space-between px-4 header-inner">
          <div class="d-flex align-center ga-2">
            <v-avatar color="#2f6b3c" rounded size="28" class="brand-avatar">
          ...
          <v-chip color="#e7f1e7" variant="flat" class="font-weight-bold text-green-darken-4 rounded-xl" size="small">
      ...
      <div class="main-content-bg pt-2">
          ...
          <v-card class="feature-card rounded-2xl overflow-hidden" elevation="10">
            ...
            <div class="pa-4 feature-body">
              ...
              <div class="d-flex align-center justify-space-between feature-actions">
                ...
                <v-btn icon color="#2f6b3c" size="36" class="elevation-4 btn-add-animated feature-add" @click="addToCart(filteredItems[0], $event)">
        ...
        <!-- Menu items -->
        <div v-else-if="filteredItems.length" class="px-4 pb-24 fade-in">
...
.mobile-layout { font-family:'Manrope',sans-serif; max-width:480px; margin:0 auto; background:#f6f7fb; min-height:100vh; position:relative; overflow-x:hidden; }
...
.sticky-header { position:fixed; top:0; left:0; right:0; max-width:480px; margin:0 auto; z-index:30; background:#f6f7fb; padding-top:16px; padding-bottom:8px; box-shadow:0 6px 16px rgba(0,0,0,.08); border-bottom:1px solid #eef2f0; }
.header-inner { padding-bottom:10px; }
.header-spacer { height:204px; }
.header-categories { padding-bottom:10px; }
.brand-avatar { box-shadow:0 6px 14px rgba(47,107,60,.25); }
.search-card :deep(.v-field) { background:#ffffff !important; box-shadow:0 8px 18px rgba(0,0,0,.08) !important; border:1px solid #eef2f0 !important; border-radius:20px !important; }
.search-input :deep(.v-field__outline) { border:none !important; }
.search-input :deep(.v-field) { box-shadow:0 2px 10px rgba(0,0,0,.03) !important; border:1px solid #e8edea; }
.category-scroll { display:flex; overflow-x:auto; scrollbar-width:none; -ms-overflow-style:none; }
.category-scroll::-webkit-scrollbar { display:none; }
.category-btn { border-color:#e8edea !important; font-weight:700; letter-spacing:0; transition:all .2s; padding:0 16px; box-shadow:0 4px 10px rgba(0,0,0,.06); border-radius:999px !important; }
.feature-card { border:1px solid rgba(0,0,0,.06); box-shadow:0 12px 24px rgba(0,0,0,.12) !important; border-radius:24px !important; }
...
.feature-add { border-radius:50% !important; box-shadow:0 8px 18px rgba(47,107,60,.35) !important; }
.popular-card { box-shadow:0 8px 16px rgba(0,0,0,.08) !important; border:1px solid rgba(0,0,0,.04); transition:transform .2s; border-radius:20px !important; }
.popular-card:active { transform:scale(.98); }
.pb-24 { padding-bottom:140px; }
.fixed-bottom-cart { position:fixed; bottom:0; left:0; right:0; max-width:480px; margin:0 auto; z-index:100; background:linear-gradient(to top,rgba(250,251,252,1) 40%,rgba(250,251,252,0)); }
.cart-pill { box-shadow:0 10px 40px rgba(33,87,50,.35) !important; cursor:pointer; transition:transform .2s; }
